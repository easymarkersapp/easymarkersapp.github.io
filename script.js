class MarkerApp {
    ...
    initViewModal() {
        ...
        this.viewModalMarkerTitle = document.getElementById('viewModalMarkerTitle');
        this.viewModalNoteText = document.getElementById('viewModalNoteText');
        this.viewModalDescriptionText = document.getElementById('viewModalDescriptionText');
        this.viewModalSaveBtn = document.getElementById('viewModalSaveBtn');
        this.viewModalCancelBtn = document.getElementById('viewModalCancelBtn');
